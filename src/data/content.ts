...
export const FRAGRANCES = [
  ...
  { id: 'f2', name: 'Desert Rose Eau', collection: 'Desert Rose', concentration: 'Eau de Parfum', price: 'AED 890', image: MEDIA.rose, top: 'Pink Pepper, Litchi', heart: 'Taif Rose, Peony', base: 'White Musk, Cedar', family: 'Floral' },
  { id: 'f3', name: 'Midnight Gold', collection: 'Midnight Gold', concentration: 'Extrait de Parfum', price: 'AED 1,490', image: MEDIA.hero, top: 'Bergamot, Cardamom', heart: 'Amber, Orchid', base: 'Incense, Tonka', family: 'Amber Oriental' },
  { id: 'f4', name: 'Arabian Velvet', collection: 'Arabian Velvet', concentration: 'Eau de Parfum', price: 'AED 950', image: MEDIA.gift, top: 'Black Plum', heart: 'Black Orchid, Suede', base: 'Tonka, Cashmere Wood', family: 'Woody Floral' },
  { id: 'f5', name: 'Oud Royale Noir', collection: 'Royal Oud', concentration: 'Parfum', price: 'AED 1,680', image: MEDIA.oud, top: 'Saffron', heart: 'Smoked Oud, Leather', base: 'Patchouli, Vetiver', family: 'Leather Woody' },
...
export const BEAUTY = [
  { id: 'b1', name: 'Gold Silk Radiance Serum', category: 'Skincare', price: 'AED 620', image: MEDIA.beauty, desc: 'A weightless elixir with 24K gold particles and rose stem cells for luminous, firm skin.' },
  { id: 'b2', name: 'Amber Body Veil', category: 'Body Care', price: 'AED 380', image: MEDIA.gift, desc: 'A silken body oil scented with our signature amber accord, leaving skin satin-soft.' },
  { id: 'b3', name: 'Rose Renewal Cream', category: 'Skincare', price: 'AED 540', image: MEDIA.beauty, desc: 'A rich night cream of Taif rose and hyaluronic complex for deep overnight repair.' },
  { id: 'b4', name: 'Oud Hammam Ritual Set', category: 'Wellness', price: 'AED 760', image: MEDIA.oud, desc: 'A complete bathing ritual — scrub, soap and oil infused with rare oud.' },
];

export const LIMITED = [
  { id: 'l1', name: 'The Sovereign — N°01', edition: 'Limited to 100 pieces', price: 'AED 4,800', image: MEDIA.hero, desc: 'A hand-numbered crystal flacon of our rarest Cambodian oud, capped in 18K gold.' },
...
export const GIFT_SETS = [
  ...
  { id: 'g3', name: 'Midnight Luxury Duo', contents: ['Midnight Gold 100ml', 'Arabian Velvet 100ml'], price: 'AED 2,100', image: MEDIA.hero },
...
export const ARTICLES = [
  ...
  { id: 'a4', slug: 'fragrance-layering-techniques', category: 'Craft', title: 'Fragrance Layering Techniques', excerpt: 'How to build a bespoke scent profile by layering oud, florals and amber.', readTime: '7 min', date: 'Feb 2025', cover: MEDIA.oud },
  { id: 'a5', slug: 'modern-perfume-trends', category: 'Culture', title: 'Modern Perfume Trends', excerpt: 'The new wave of gender-fluid orientals redefining contemporary luxury.', readTime: '5 min', date: 'Jan 2025', cover: MEDIA.gift },
];
